...
CondAver = ConditionalAveragerAesSbox(256, trace_length)
...
for i in range(tracesToSkip - 1, N):
    ...
    if (((i + 1) % evolutionStep == 0) or ((i + 1) == N)):
        ...
        CpaCorrectCandidateRank2 = np.count_nonzero(CorrPeaks >= CorrPeaks[knownKey[SboxNum+1]])
        CpaCorrectCandidatePeak2 = CorrPeaks[knownKey[SboxNum+1]]
